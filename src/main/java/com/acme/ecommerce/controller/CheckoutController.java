...
public class CheckoutController {
	...
	String checkoutConfirmation(Model model) {
		...
		String maskedCC = maskCC(purchase.getCreditCardNumber());
		...
		if (purchase != null) {
			...
			model.addAttribute("creditCard", maskedCC);
		} else {
			logger.error("No purchases Found!");
			return ("redirect:/error");
		}
	...
	private String maskCC(String creditCardNumber) {
		...
		sb.append(creditCardNumber.substring(length - 4, length));
